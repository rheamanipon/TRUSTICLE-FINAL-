...
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <div class="sidebar-menu">
            ...
            <a href="../admin/manage_article.php" class="menu-item">
            ...
            <a href="../admin/activity_log.php" class="menu-item">
            ...
            <div class="submenu" id="settingsSubmenu">
                <a href="../admin/settings.php#edit-profile" class="submenu-item" id="edit-profile-link">
                    <i class="fas fa-user-edit"></i>
                    <span>Edit Profile</span>
                </a>
                <a href="../admin/settings.php#account-security" class="submenu-item" id="account-security-link">
        ...
        <div class="user-profile">
            ...
            <div class="user-dropdown">
                <a href="../admin/settings.php#edit-profile" class="dropdown-item">Edit Profile</a>
                <a href="logout.php" class="dropdown-item logout-option">Logout</a>
            </div>
        </div>
    </div>
</body>
